...
int main(int argc, char* argv[])
{
    ...
    g_Window = SDL_CreateWindow("Dear ImGui SDL2+Vulkan main window", ImGui::SysWndPos.x, ImGui::SysWndPos.y, ImGui::SysWndPos.w, ImGui::SysWndPos.h, window_flags);
    if (g_Window == nullptr)
    {
    ...
    while (!ImGui::AppExit)
    {
        ...
        if (!is_minimized)
        {
            wd->ClearValue.color.float32[0] = ImGui::SysWndBgColor.x * ImGui::SysWndBgColor.w;
            wd->ClearValue.color.float32[1] = ImGui::SysWndBgColor.y * ImGui::SysWndBgColor.w;
            wd->ClearValue.color.float32[2] = ImGui::SysWndBgColor.z * ImGui::SysWndBgColor.w;
            wd->ClearValue.color.float32[3] = ImGui::SysWndBgColor.w;
